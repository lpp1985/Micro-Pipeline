...
aa<-ggplot(countsTable)+geom_bar(aes(x=Function, fill=Function),show_guide =FALSE)+coord_flip()+ylab("Gene Number")+theme(axis.text.y=element_text(size=25,color="darkred",face="bold"))
